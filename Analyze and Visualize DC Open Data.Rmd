...
###Follow along to the presentation here: http://rpubs.com/datalensdc/208449
###Find the data we're using and the code to create this presentation here: http://bit.ly/2cBtK2S
...
###We also performed our first function - read.csv! 
How'd that work?
...
* read.csv reads in a comma-separated value file to create a data.
...
* There are 10 variables and 24 observations. 

* Variables can come in with three different data types: character (for text data), factor (for categorical data), and numeric (for numerical data). 

* Variables can come in with three different types:
...
There are four datasets [here](https://github.com/katerabinowitz/CodeHer16/tree/master/data) that are structured just like the one we've been working with. Pick one and start doing analysis/graphics on your own or with a partner! I'll be floating around to help but don't forget RStudio's ? function too.  
...
###We'll share what we've worked on before the workshop ends. But also keep it up past today and let me know what you find!
