...
require(dplyr)
require(reshape2)
dcPop<-read.csv("https://raw.githubusercontent.com/katerabinowitz/CodeHer16/master/data/ninfoDCPop.csv")
dcWB<-read.csv("https://raw.githubusercontent.com/katerabinowitz/CodeHer16/master/data/ninfoDCWB.csv")
dcHouse<-read.csv("https://raw.githubusercontent.com/katerabinowitz/CodeHer16/master/data/ninfoDCHousing.csv")
dcSchools<-read.csv("https://raw.githubusercontent.com/katerabinowitz/CodeHer16/master/data/ninfoDCSchools.csv")
...
write.csv(dcHouse,"/Users/katerabinowitz/Documents/Talks/CodeHer16/data/dcHomeSales.csv")
write.csv(dcPop,"/Users/katerabinowitz/Documents/Talks/CodeHer16/data/dcPopulation.csv")
write.csv(dcSchools,"/Users/katerabinowitz/Documents/Talks/CodeHer16/data/dcSchools.csv")
write.csv(dcWB,"/Users/katerabinowitz/Documents/Talks/CodeHer16/data/dcIncome.csv")
